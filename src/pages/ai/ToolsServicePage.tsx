        ...
        <CardContent className="space-y-4">
          ...
          <div className="p-3 bg-muted rounded-md">
            ...
            <ol className="list-decimal list-inside space-y-1 text-sm">
              ...
              <li>Ensure network connectivity to the function server</li>
            </ol>
          </div>
        </CardContent>
      </Card>
  ...
  return (
    <div className="container mx-auto py-8 max-w-5xl">
      <div className="space-y-8">
        {/* Header */}
        <div className="space-y-2">
          <h1 className="text-3xl font-bold tracking-tight">Neo4j Graph Database Tools</h1>
          <p className="text-muted-foreground">
            Connect to a Neo4j database and run natural language queries using LangChain
          </p>
        </div>
        ...
        >
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="code">Code Reference</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="query" className="space-y-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Neo4j Database Connection</CardTitle>
                <CardDescription>
                  Enter your Neo4j database credentials to connect
                </CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          type="password"
                          placeholder="Enter your Neo4j database password"
                          disabled={isConnected || isLoading}
                        />
                      </FormControl>
                    </FormItem>
                    ...
                    <div>
                      {isConnected ? (
                        <span className="text-sm flex items-center text-green-600">
                          ...
                          Connected to Neo4j {useDummyResponse && "(Demo Mode)"}
                        </span>
                      ) : connectionError ? (
                ...
                <form onSubmit={handleQuerySubmit} className="space-y-4">
                  <div className="flex space-x-2">
                    <Input
                      ...
                      placeholder="e.g., Show me all non-profit organizations in California"
                      disabled={!isConnected || isLoading}
                    />
                    <Button
                      type="submit"
                  ...
                  {useDummyResponse && isConnected && (
                    <Alert variant="warning">
                      <AlertTriangle className="h-4 w-4" />
                      <AlertTitle>Demo Mode Active</AlertTitle>
                      <AlertDescription>
                        Using demo data because we could not connect to the actual serverless function.
                        Responses are pre-defined examples, not actual database queries.
                      </AlertDescription>
                    </Alert>
                  )}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="bg-muted p-2 rounded-md text-sm">
                      {executionSteps.length === 0 ? (
                        <p className="text-muted-foreground italic">Connect to database and run a query to see execution steps</p>
                      ) : (
            ...
            {cypherQuery && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    The LLM generated this Cypher query from your natural language question
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            {result && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    The answer to your question based on the graph database
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="bg-card rounded-md p-4 border text-sm">
                ...
                <AccordionItem value="debug">
                  ...
                  <AccordionContent>
                    <div className="bg-muted p-3 rounded-md overflow-x-auto">
                      <pre className="text-xs font-mono">{JSON.stringify(debugInfo, null, 2)}</pre>
                    </div>
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
          ...
          <TabsContent value="code">
              ...
              <CardHeader>
                <CardTitle>
                  <div className="flex items-center">
                    ...
                    Langchain Vector Index Code
                  </div>
                </CardTitle>
                <CardDescription>
                  This code demonstrates how to initialize a Neo4j Vector Store using LangChain
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="bg-muted rounded-md p-4 font-mono text-sm overflow-x-auto">
                  <pre className="whitespace-pre-wrap">{codeBlocks.vectorIndex}</pre>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="mb-6">
              <CardHeader>
                ...
                <CardDescription>
                  LangChain prompt templates for generating Cypher queries and formatting answers
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="bg-muted rounded-md p-4 font-mono text-sm overflow-x-auto">
                  <pre className="whitespace-pre-wrap">{codeBlocks.promptTemplates}</pre>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configuring the GraphCypherQAChain for natural language to Cypher query conversion
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="bg-muted rounded-md p-4 font-mono text-sm overflow-x-auto">
                  <pre className="whitespace-pre-wrap">{codeBlocks.graphChain}</pre>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
